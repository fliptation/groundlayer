...
const sectionMeta: Record<string, { href: string; color: string }> = {
  projects: { href: "/collaborate/projects", color: "green-sage" },
  ideas: { href: "/collaborate/ideas", color: "terracotta" },
  discussions: { href: "/collaborate/discussions", color: "brown" },
};
...
export default async function CollaboratePage() {
  ...
  return (
    <article className="max-w-4xl mx-auto px-6 lg:px-10 py-20 md:py-28">
      ...
      <div
        className="bg-green-light/30 border border-green-muted/20 rounded-2xl p-6 text-center"
        style={{ fontFamily: "var(--font-geist-sans), sans-serif" }}
      >
